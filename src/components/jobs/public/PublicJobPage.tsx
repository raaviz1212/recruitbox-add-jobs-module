...
const JOB_DATA = {
  ...
  description: 'Are you a graduating student with a passion for software engineering, ready to launch your career in 2024? We invite you to be part of our dynamic Fresh Grad Program.',
  responsibilities: [
